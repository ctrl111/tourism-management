...
<!--      request.post("/collection/add", formData.value).then(res => {-->
<!--        if (!res) {-->
<!--          return-->
<!--        }-->
<!--        dialogOpen.value = false-->
...
<!--    } else {-->
<!--      //更新-->
<!--      request.put("/collection/update", formData.value).then(res => {-->
<!--        if (!res) {-->
<!--          return-->
<!--        }-->
<!--        dialogOpen.value = false-->
...
<!--    center: true-->
<!--  }).then(() => {-->
<!--    request.delete("/collection/delBatch", {data: ids}).then(res => {-->
<!--      if (!res) {-->
<!--        return-->
<!--      }-->
<!--      ElMessage({-->
