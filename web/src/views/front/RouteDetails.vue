    ...
    <div class="detail-wrapper">
        ...
        <div class="travel-meta-header">
          ...
          <div class="time-meta">
            ...
            <div class="meta-item">
              ...
              <span>预估费用：￥{{ info.totalCost }}元</span>
            </div>
          </div>
        </div>
      ...
      <div class="content-section">
        ...
        <div class="daily-schedule-section">
          <h2 class="schedule-title">每日行程安排</h2>
          <div
              v-for="(day, index) in info.daysList"
              :key="index"
              class="day-card"
          >
...
function getInfo() {
  request.get("/route/selectById/" + id.value,).then(res => {
    info.value = res.data
    isLiked.value = res.data.liked
  })
  //增加浏览量
  request.get("/route/putViewCount/" + id.value,).then(res => {
  })
}
